...
int main(void) {
  ...
  s21_suit_execution(s21_remove_matrix_suite(), &failed_count,
                     "remove_matrix.log");
  s21_suit_execution(s21_eq_matrix_suite(), &failed_count, "eq_matrix.log");
  s21_suit_execution(s21_sum_matrix_suite(), &failed_count, "sum_matrix.log");
  s21_suit_execution(s21_sub_matrix_suite(), &failed_count, "sub_matrix.log");
  s21_suit_execution(s21_mult_number_suite(), &failed_count, "mult_number.log");
  s21_suit_execution(s21_mult_matrix_suite(), &failed_count, "mult_matrix.log");
  s21_suit_execution(s21_transpose_suite(), &failed_count, "transpose.log");
  s21_suit_execution(s21_calc_complements_suite(), &failed_count,
                     "calc_complements.log");
  s21_suit_execution(s21_determinant_suite(), &failed_count, "determinant.log");
